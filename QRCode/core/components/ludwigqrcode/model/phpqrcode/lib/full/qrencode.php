...
class QRrsblock
{
	 ...
	 *        	ECC length
	 * @param Array $el
	 *        	ECC stream (modified, by reference)
	 * @param QRrsItem $rs
	 *        	RS encoding item
	 */
...
class QRrawcode
{
	 ...
	 * 
	 * @param Array $spec
	 *        	code speciffigation, as provided by QRspec
	 */
...
class QRcode
{
	 ...
	 *        	code version (size of code area)
	 * @param Integer $level
	 *        	ECC level (see: Global Constants -> Levels of Error Correction)
	 * @return QRcode $this (current instance)
	 */
	 ...
	 *        	ECC level (see: Global Constants -> Levels of Error Correction)
	 * @param Integer $hint
	 *        	__QR_MODE_8__ or __QR_MODE_KANJI__, Because Kanji encoding
	 ...
	 *        	hint if given string is case-sensitive, because
	 ...
	 *        	(optional) output file name, if __false__ outputs to browser with required headers
	 * @param Integer $level
	 ...
	 *        	(optional) if __true__ code is outputed to browser and saved to file, otherwise only saved to file. It is effective only if $outfile is specified.
	 */
	 ...
	 *        	(optional) not used, shuold be __false__
	 * @param Integer $level
	 *        	(optional) error correction level __QR_ECLEVEL_L__, __QR_ECLEVEL_M__, __QR_ECLEVEL_Q__ or __QR_ECLEVEL_H__
	 * @param Integer $size
	 *        	(optional) pixel size, multiplier for each 'virtual' pixel
	 ...
	 */
	public static function svg( $text, $elemId = false, $outFile = false, $level = QR_ECLEVEL_L, $width = false, $size = false, $margin = 4, $compress = false, $back_color = 'transparent', $fore_color = 0x000000, $position_color = false, $gradient_color = false, $stroke = false, $support = false )
	{
...
class QRframeFiller
{
	 ...
	 * 
	 * @param Array $at
	 *        	position, map containing __x__ and __y__ coordinates
	 * @param Integer $val
	 *        	value to set
	 */
...
class QRencode
{
	 ...
	 * 
	 * @param Integer $level
	 *        	error correction level __QR_ECLEVEL_L__, __QR_ECLEVEL_M__, __QR_ECLEVEL_Q__ or __QR_ECLEVEL_H__
	 * @param Integer $size
	 *        	pixel zoom factor, multiplier to map virtual code pixels to image output pixels
	 * @param Integer $margin
	 *        	margin (silent zone) size, in code pixels
	 ...
	 * @param String $intext
	 *        	input text
	 * @param Boolean $notused
	 *        	(optional, not used) placeholder for similar outfile parameter
	 ...
	 *        	input text
	 * @param String $outfile
	 *        	(optional) output file to save code table, if __false__ file will be not saved

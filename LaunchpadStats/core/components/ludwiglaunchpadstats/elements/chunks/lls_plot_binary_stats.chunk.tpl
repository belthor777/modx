<div itemscope itemtype="http://schema.org/SoftwareApplication">
	<div itemprop="name">[[+title]]</div>
        <meta itemprop="SoftwareApplicationCategory" content="http://schema.org/CommunicationApplication"/>
		<meta itemprop="interactionCount" content="UserDownloads:[[+total_downloads]]"/>
        <span itemprop="SoftwareApplicationSubCategory">UPnP Server</span>
        <div itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating">
            [[+title]] is rated <span itemprop="ratingCount">11</span> times with

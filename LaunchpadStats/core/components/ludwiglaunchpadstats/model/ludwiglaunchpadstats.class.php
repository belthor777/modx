...
class LudwigLaunchpadStats
{
	...
	public function __construct( modX &$modx )
	{
		...
		$config = array(	'format' => 'json', // json or xml, the format to request
	...
	// Parameters: 
	//	$fields: A multi array
	//	$skey: Key to sum e.g. 'total_dl'
